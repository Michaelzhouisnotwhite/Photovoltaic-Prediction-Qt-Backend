...
def do_args(args: argparse.ArgumentParser):
...
def get_args_from_shell():
    do_args(args=get_parser().parse_args())


def get_args_from_list(arg_list: list):
    do_args(args=get_parser().parse_args(arg_list))
